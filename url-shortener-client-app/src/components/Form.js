...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        var generatedURL = "smolink.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "smolink.com/" + this.state.preferedAlias
        }
        ...
        return (
            <div className="container">
                <form autoComplete="off">
                    <h3>Create your shorter link!</h3>
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">smolink.com/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
                                ...
                                type="text" placeholder="eg. hte23w (Optional)"
                            />
                        </div>
                        <div
                            className={
